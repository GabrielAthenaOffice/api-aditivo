...
import com.formulario.athena.service.security.LoginService;
...
public class AuthenticationController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UserDTO> atualizarUsuario(@PathVariable String id,
    ...
    public ResponseEntity<UserDTO> deletarUsuario(@PathVariable String id) {
    ...
    public ResponseEntity<?> logoutApp() {
        ...
        return ResponseEntity.ok()
                ...
                .body(new APIExceptions("You have been signed out"));
    }
